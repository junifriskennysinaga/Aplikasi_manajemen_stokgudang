        ...
        <div>
            <h1 class="text-4xl font-black flex items-center gap-3">
                ...
                <span>
                    ...
                    <span class="text-gray-700 italic">Masuk</span>
                </span>

            </h1>

            <p class="text-gray-500 mt-2 text-sm tracking-wide">
                Kelola stok barang masuk dengan cepat & rapi
            </p>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                @forelse($barang as $b)
                    ...
                    <tr class="border-b hover:bg-pink-50 transition duration-200">
                        ...
                        <!-- FORM INPUT -->
                        <td class="p-4 text-center">
                            <form method="POST" action="/barang-masuk" class="flex justify-center gap-2 items-center">
                                @csrf
